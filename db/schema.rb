...
ActiveRecord::Schema.define(version: 2018_08_24_104723) do
  ...
  create_table "laptop_shops", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "laptop_id"
    t.bigint "shop_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["laptop_id"], name: "index_laptop_shops_on_laptop_id"
    t.index ["shop_id"], name: "index_laptop_shops_on_shop_id"
  end
  ...
  add_foreign_key "laptop_shops", "laptops"
  add_foreign_key "laptop_shops", "shops"
